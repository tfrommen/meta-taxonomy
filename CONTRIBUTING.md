...
* See if your issue has been discussed (or even fixed) earlier. You can [search for existing issues](https://github.com/tfrommen/meta-taxonomy/issues?q=is%3Aissue).
* Assuming it does not already exist, [create a new issue](https://github.com/tfrommen/meta-taxonomy/issues/new).
...
* [Create a pull request](https://github.com/tfrommen/meta-taxonomy/compare) to the original repository.
* Wait for feedback.
